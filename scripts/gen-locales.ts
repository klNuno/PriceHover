...
const MESSAGES: Record<string, Entry> = {
  ...
  hoverDelayHelp: {
    en: 'How still the pointer must be before the tooltip appears. Longer means fewer tooltips flashing past while you read.',
    fr: 'Temps d’immobilité du curseur avant l’apparition de l’infobulle. Plus long, moins d’infobulles qui clignotent pendant la lecture.',
    es: 'Cuánto debe detenerse el cursor antes de que aparezca el tooltip. Más tiempo, menos tooltips parpadeando al leer.',
    de: 'Wie lange der Zeiger stillstehen muss, bevor der Tooltip erscheint. Länger heißt weniger aufblitzende Tooltips beim Lesen.',
    pt_BR: 'Quanto tempo o cursor deve ficar parado antes de a dica aparecer. Mais tempo, menos dicas piscando durante a leitura.',
    it: 'Quanto deve restare fermo il puntatore prima che appaia il tooltip. Più lungo, meno tooltip che lampeggiano mentre leggi.',
    ja: 'ツールチップが出るまでカーソルを静止させる時間。長くすると読書中の点滅が減ります。',
    zh_CN: '指针需静止多久才显示提示框。时间越长，阅读时闪烁的提示越少。',
  },
  delayInstant: {
  ...
  inlineModeHelp: {
    en: 'Shows your currency next to every price, without hovering. Hovering still opens the full list.',
    fr: 'Affiche votre devise à côté de chaque prix, sans survol. Le survol ouvre toujours la liste complète.',
    es: 'Muestra tu moneda junto a cada precio, sin pasar el cursor. El cursor sigue abriendo la lista completa.',
    de: 'Zeigt Ihre Währung neben jedem Preis, ohne Überfahren. Der Tooltip zeigt weiterhin die ganze Liste.',
    pt_BR: 'Mostra sua moeda ao lado de cada preço, sem passar o cursor. O cursor ainda abre a lista completa.',
    it: 'Mostra la tua valuta accanto a ogni prezzo, senza passare il cursore. Il cursore apre comunque l’elenco completo.',
    ja: 'ホバーせずに各価格の横へ自国通貨を表示します。ホバーすれば全一覧が開きます。',
    zh_CN: '无需悬停即在每个价格旁显示你的货币。悬停仍会打开完整列表。',
  },
  pageContext: {
  ...
  pageContextHelp: {
    en: 'On a .ca domain $ means Canadian dollars, on a .no domain kr means Norwegian krone. Off, they always mean USD and SEK.',
    fr: 'Sur un domaine .ca, $ vaut dollar canadien ; sur .no, kr vaut couronne norvégienne. Désactivé, ils valent toujours USD et SEK.',
    es: 'En un dominio .ca, $ significa dólar canadiense; en .no, kr significa corona noruega. Desactivado, siempre son USD y SEK.',
    de: 'Auf einer .ca-Domain heißt $ kanadischer Dollar, auf .no heißt kr norwegische Krone. Aus bedeutet immer USD und SEK.',
    pt_BR: 'Em um domínio .ca, $ significa dólar canadense; em .no, kr significa coroa norueguesa. Desligado, sempre valem USD e SEK.',
    it: 'Su un dominio .ca $ significa dollaro canadese, su .no kr significa corona norvegese. Disattivato, valgono sempre USD e SEK.',
    ja: '.ca ドメインでは $ をカナダドル、.no では kr をノルウェークローネと解釈します。オフの場合は常に USD と SEK です。',
    zh_CN: '在 .ca 域名上 $ 表示加元，在 .no 上 kr 表示挪威克朗。关闭后一律视为 USD 和 SEK。',
  },
  enabledEverywhere: {
  ...
  privacyNote: {
    en: 'PriceHover contacts one host, open.er-api.com, for exchange rates. Nothing about the pages you visit ever leaves your browser.',
    fr: 'PriceHover contacte un seul hôte, open.er-api.com, pour les taux de change. Rien sur les pages que vous visitez ne quitte votre navigateur.',
    es: 'PriceHover contacta con un solo host, open.er-api.com, para las tasas de cambio. Nada sobre las páginas que visitas sale de tu navegador.',
    de: 'PriceHover kontaktiert genau einen Host, open.er-api.com, für Wechselkurse. Nichts über die von Ihnen besuchten Seiten verlässt den Browser.',
    pt_BR: 'O PriceHover contata apenas um host, open.er-api.com, para as taxas de câmbio. Nada sobre as páginas que você visita sai do seu navegador.',
    it: 'PriceHover contatta un solo host, open.er-api.com, per i tassi di cambio. Nulla sulle pagine che visiti lascia il browser.',
    ja: 'PriceHover が通信する相手は為替レートの open.er-api.com ただ一つです。閲覧したページの情報がブラウザーの外に出ることはありません。',
    zh_CN: 'PriceHover 只连接 open.er-api.com 获取汇率。你访问过的页面信息绝不会离开浏览器。',
  },
  ...
  welcomeBody: {
    en: 'Pick your currency below, then hover any price on any page.',
    fr: 'Choisissez votre devise ci-dessous, puis survolez un prix sur n’importe quelle page.',
    es: 'Elige tu moneda abajo y pasa el cursor sobre cualquier precio.',
    de: 'Wählen Sie unten Ihre Währung und fahren Sie über einen beliebigen Preis.',
    pt_BR: 'Escolha sua moeda abaixo e passe o cursor sobre qualquer preço.',
    it: 'Scegli la tua valuta qui sotto, poi passa il cursore su un prezzo.',
    ja: '下で自国通貨を選び、任意の価格にカーソルを合わせてください。',
    zh_CN: '在下方选择你的货币，然后将鼠标悬停在任意价格上。',
  },
  welcomeDismiss: {
